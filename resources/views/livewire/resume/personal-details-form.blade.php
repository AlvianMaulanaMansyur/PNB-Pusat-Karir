...
<div>
    <div id="personal-details-section" class="panel-container">
        <div class="panel-header flex justify-between items-center">
            <h3>Personal Details</h3>
            {{-- Tombol "Save" dihilangkan karena ada auto-save via wire:model.live atau updated() --}}
            {{-- <button wire:click="savePersonalDetails" class="save-btn">Save</button> --}}
        </div>
        ...
        <div class="panel-body">
            <div class="gap-6">
                ...
                <div class="md:col-span-1 flex flex-col items-center">
                    <label for="profilePhotoFile" class="block text-sm font-medium text-gray-700 mb-2">Profile Photo</label>
                    <div class="relative w-32 h-32 rounded-full overflow-hidden border-2 border-gray-300 flex items-center justify-center bg-gray-100">
                        ...
                        @endif
                        <input type="file" id="profilePhotoFile" wire:model.live="profilePhotoFile" class="absolute inset-0 opacity-0 cursor-pointer" accept="image/*">
                    ...
                    @enderror
                    @if ($profilePhotoPreview)
                        <button type="button" wire:click="removePhoto" class="text-red-600 text-sm mt-2 hover:underline">Remove Photo</button>
                    @endif
                    <div wire:loading wire:target="profilePhotoFile" class="text-blue-600 text-sm mt-2">Uploading photo...</div>
                </div>

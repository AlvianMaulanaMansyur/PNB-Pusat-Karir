...
<div class="p-6">
    ...
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Verifikasi Akun Employee</h1>
            ...
            <tbody class="divide-y divide-gray-100 text-gray-700">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-center">
                        @if ($user->is_active)
                            <span class="inline-block px-3 py-1 text-xs font-bold text-green-800 bg-green-300 rounded-full">
                                TERVERIFIKASI
                            </span>
                        @else
                            <span class="inline-block px-3 py-1 text-xs font-bold text-yellow-900 bg-yellow-400 rounded-full">
                                DITOLAK
                            </span>
                        @endif
                    </td>

    ...
    <div class="flex justify-center bg-gray-100 min-h-screen">
        <main class="w-full max-w-7xl bg-white p-8 mt-6 shadow-md rounded-lg">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <form action="{{ route('admin.manajemenevent') }}" method="GET"
                    ...
                    <button type="submit"
                        class="flex items-center gap-2 bg-blue-900 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-800 transition">
                    ...
                    <tbody class="text-gray-700">
                        @forelse ($events as $event)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="border px-4 py-3">{{ \Carbon\Carbon::parse($event->event_time)->format('H:i') }}
                                </td>
                                ...
                                <td class="border px-4 py-3 text-center">
                                    <span
                                        class="{{ $event->is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }} px-2 py-1 rounded text-xs font-semibold">
                                ...
                                <td class="border px-4 py-3 text-center space-x-2">
                                    ...
                                    <button onclick="confirmDelete({{ $event->id }})"
                                        class="text-red-600 hover:underline text-sm" type="button">
                                        Hapus
                                    </button>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center px-4 py-6 text-gray-500 italic">Belum ada event yang
                                    tersedia.</td>
                            </tr>
                        @endforelse
                    </tbody>

    ...
    <main class="w-full max-w-4xl bg-white p-8 shadow-md rounded-lg">
        ...
        <form action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" maxlength="100" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm" required>
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm" required></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" name="event_date" id="event_date" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm" required>
                </div>
                <div>
                    <label for="event_time" class="block font-semibold text-gray-700 mb-1">Waktu Event</label>
                    <input type="time" name="event_time" id="event_time" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm" required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="location" id="location" maxlength="100" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm" required>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center gap-4">
                    <label><input type="radio" name="needs_registration" value="1"> Ya</label>
                    <label><input type="radio" name="needs_registration" value="0" checked> Tidak</label>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="max_participants" id="max_participants" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm">
                </div>
                <div>
                    <label for="registration_link" class="block font-semibold text-gray-700 mb-1">Link Pendaftaran (Opsional)</label>
                    <input type="url" name="registration_link" id="registration_link" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="file" name="flyer" id="flyer" accept="image/*" class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm" required>
            </div>

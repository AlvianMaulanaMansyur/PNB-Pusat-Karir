...
<body class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="flex flex-col md:flex-row w-full h-screen bg-white border border-gray-300">
        <!-- Kiri (Form Login) -->
        <div
            class="md:w-1/2 w-full bg-blue-900 text-white p-10 flex flex-col justify-center rounded-tr-[150px] md:rounded-tr-[150px] md:rounded-br-[150px]">
            ...
            <form action="" method="POST" class="space-y-4">
                ...
                <button type="submit"
                    class="w-full bg-blue-600 text-white font-bold py-2 rounded hover:bg-blue-700">LOG IN</button>
            </form>
        </div>

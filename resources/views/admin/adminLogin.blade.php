...
<body class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div
        class="flex flex-col md:flex-row w-full max-w-6xl h-screen md:h-[600px] bg-white shadow-lg overflow-hidden rounded-lg border border-gray-200">

        <!-- Kiri (Form Login) -->
        <div
            class="md:w-1/2 w-full bg-blue-900 text-white px-10 py-12 flex flex-col justify-center md:rounded-tr-[150px] md:rounded-br-[150px]">
        ...
        <div class="md:w-1/2 w-full bg-white flex flex-col items-center justify-center px-10 py-12">
            ...
            <p class="text-center text-sm text-gray-600 px-4">Untuk melanjutkan ke dashboard, silakan login menggunakan
                akun Anda.</p>
        </div>
    </div>
</body>
